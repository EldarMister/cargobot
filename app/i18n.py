...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "ru": {
        ...
        "warehouse_title_numbered": "📦 <b>Адрес склада в Китае №{number}</b>",
    ...
    "en": {
        ...
        "warehouse_title_numbered": "📦 <b>China warehouse address #{number}</b>",
    ...
    "zh": {
        ...
        "warehouse_title_numbered": "📦 <b>中国仓库地址 {number}</b>",
